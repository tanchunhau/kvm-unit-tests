...
const char* expected_device_power_names[expected_number_of_domains] =
        {"dpwr0", "dpwr1", "dpwr2", "dpwr3", "dpwr4", "dpwr5"};

const u32 expected_device_power_latencies[expected_number_of_domains] =
        {100, 120, 90, 110, 130, 140};

const u32 expected_device_power_flags[expected_number_of_domains] =
        {6, 6, 6, 6, 6, 6};
